# https://pypi.org/project/nonechucks/
# (I would install the package, but it insists of parsing the pytorch version
#  -- in a way that breaks with pytorch nightly ¯\_(ツ)_/¯  )
...
class SafeDataset(torch.utils.data.Dataset):
  ...
  def is_index_built(self):
    """Returns True if all indices of the original dataset have been
        ...
        """
    return len(
        self.dataset) == len(self._safe_indices) + len(self._unsafe_indices)
